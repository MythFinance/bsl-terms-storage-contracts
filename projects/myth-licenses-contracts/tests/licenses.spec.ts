...
import { LicensesFactory } from '../smart_contracts/artifacts/licenses/LicensesClient'
import { Account, Algodv2, Indexer } from 'algosdk'
import { Config } from '@algorandfoundation/algokit-utils'
import { TransactionSignerAccount } from '@algorandfoundation/algokit-utils/types/account'

describe('licenses contract', () => {
  ...
  const deploy = async (account: Account & TransactionSignerAccount) => {
    const factory = localnet.algorand.client.getTypedAppFactory(LicensesFactory, {
